...
const { formatVariable, applyText } = require("../functions.js");

module.exports = class Greeting {

    constructor() {
        this.username = "Aimi";
        this.guildName = "Aimi's Server";
        this.colorTitleBorder = "#000000";
        this.colorMemberCount = "#ffffff";
        this.textMemberCount = "- {count}th member !";
        this.memberCount = "69420";
        this.backgroundImage = `https://i.redd.it/vda9rbt01en01.png`;
        this.avatar = `https://cdn.discordapp.com/avatars/828924623831433216/e24832d3e84b8c33384a94749e0562a1.png?size=128`;
